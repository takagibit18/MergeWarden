...
> 历史研究提案（2026-09-12 分类）：保留公平对照、路由与统计设计；下文“当前”和版本轴属于原规划基线，不能替代现行 [兼容矩阵](finding-contract-compatibility-matrix-20260910.md)。自适应路由及正式实验门尚未在本次清理中逐项验收，见 [维护待办](maintenance_backlog.md)。
